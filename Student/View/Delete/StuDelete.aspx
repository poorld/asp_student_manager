<%@ Page Title="" Theme="Main" Language="C#" MasterPageFile="~/Master/MasterPager.Master" AutoEventWireup="true" CodeBehind="StuDelete.aspx.cs" Inherits="Student.Service.Delete.StuDelete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:Button Text="查询" runat="server" OnClick="Unnamed_Click1" />
    <asp:Button Text="删除" runat="server" OnClick="Unnamed_Click" />
</asp:Content>
